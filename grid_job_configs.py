...
def main():
    ...
    for config in configs:
        ...
        cmds += f'lstchain_dl1_to_dl2 -f {dl1_gamma_test}  -o {outdir} -c {config_path}\n\n'
        cmds += f'lstchain_dl1_to_dl2 -f {dl1_proton_test}  -o {outdir} -c {config_path}\n\n'
        cmds += f'lstchain_dl1_to_dl2 -f {dl1_electron_test} -o {outdir} -c {config_path}\n\n'
        
        
        dl2_gamma_test = dl1_gamma_test.replace('dl1', 'dl2')
        dl2_proton_test = dl1_proton_test.replace('dl1', 'dl2')
        dl2_electron_test = dl1_electron_test.replace('dl1', 'dl2')
